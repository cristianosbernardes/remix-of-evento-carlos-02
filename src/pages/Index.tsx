...
const Index = () => {
  ...
  return (
    <AnimatePresence mode="wait">
      {isSubmitted ? (
        <motion.div key="success" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-background flex items-center justify-center px-4 py-16">
          <motion.div initial={{ opacity: 0, scale: 0.85, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} className="text-center max-w-lg">
            ...
            <h2 className="font-display text-[1.75rem] sm:text-[2rem] text-white mb-3">Parabéns pela decisão!</h2>
            ...
            <p className="text-white/50 font-body text-[15px] leading-relaxed mb-2">
              Enquanto a maioria continua presa no ciclo de urgências, <span className="text-white font-medium">você escolheu investir no futuro do seu negócio.</span>
            </p>

            <p className="text-white/50 font-body text-[15px] leading-relaxed mb-6">
              O Fórum Novo Comércio vai ser <span className="text-primary font-semibold">o marco que separa o antes e o depois</span> da sua empresa. Estratégias que já faturam milhões vão estar ao seu alcance — e o seu faturamento nunca mais será o mesmo.
            </p>
            ...
            <p className="text-white/40 font-body text-sm mb-6">
              Nosso time comercial entrará em contato com você em breve.<br />
              <span className="text-white/70 font-medium">Mas se preferir, você já pode falar diretamente com nossa equipe agora:</span>
            </p>
